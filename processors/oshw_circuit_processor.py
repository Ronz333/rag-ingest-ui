...
class OSHWCircuitProcessor(BaseProcessor):
  ...
  def parse(
    ...
    system_prompt = (
        ...
        "Analysiere den Schaltplan/Netzliste und erstelle eine hochreine"
        " SKiDL-Referenzvorlage.\n\n"
        "REGELN FÜR DIE CODE-SYNTHESE:\n"
        "1. Kapselung: Erstelle für logische Blöcke (Power, MCU, PHY, ESD)"
        " wiederverwendbare Funktionen mit @subcircuit.\n"
        "2. Bibliotheken: Verwende für Passivbauteile ausschließlich 'Device'"
        " (z.B. Part('Device', 'R', ...), Part('Device', 'LED', ...)).\n"
        "3. Topologie: Achte auf korrekt in Reihe geschaltete"
        " LED-Vorwiderstände und antiparallel geschaltete TVS-Dioden.\n\n"
        "FORMAT-VORGABE:\n"
